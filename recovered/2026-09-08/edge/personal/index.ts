...
async function proveedoresDisponibles(sb: SB, userId: string): Promise<Prov[]> {
  ...
  return out.sort((a, b) => (a.slug === "abacus" ? -1 : b.slug === "abacus" ? 1 : b.calidad - a.calidad));
}
